  ...
  return (
    <React.Fragment>
      <Element name="about">
        <div
          ref={ref}
          className="flex flex-col pb-[7rem] md:pb-0 md:flex md:flex-row justify-center pl-[10%] sm:min-h-screen h-[auto] w-full"
        >
          ...
          {/* Second Row */}
          <div className="hidden lg:flex lg:justify-end lg:pl-[2rem] lg:items-center ">
